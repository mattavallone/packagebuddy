...
class SiameseMaskRCNN(object):
    def __init__(self):
        ...
        self.rgb_image_topic = rospy.get_param('~image_topic', default='/cv_camera/image_raw')  # RGB image topic
...
if __name__ == '__main__':
    rospy.init_node('siameseMaskRCNN_predict') # update node name someplace else
