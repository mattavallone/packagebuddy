...
sys.path.append('~/siamese-mask-rcnn')
MASK_RCNN_MODEL_PATH = 'siamese-mask-rcnn/lib/Mask_RCNN/'
...
class SiameseMaskRCNNServer(object):
    def __init__(self):
        ...
        # self.backend = rospy.get_param('~backend', default='full_siameseMaskRCNN')                          
        # self.input_size = rospy.get_param('~input_size', default=416)                            # Input image size
        ...
        # self.weights_path = rospy.get_param('~weights_path', default='../checkpoints/small_siamese_mrcnn_0160.h5')   # Path to the weights.h5 file
